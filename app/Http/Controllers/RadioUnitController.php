...
class RadioUnitController extends Controller
{
     ...
     *
     */
    public function getAllRadios(Request $request)
    {
        try {
    ...
    public function getRadio(Request $request, $id)
    {
        try {
            ...
            $data = RadioUnit::with(['owner'])->where('id',$id)->first();
